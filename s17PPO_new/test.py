...
#     def __init__(self, state_dim, action_dim_1, action_dim_2):
#         super(ActorNetwork, self).__init__()
#         self.fc1 = nn.Linear(state_dim, 64)
#         self.fc2 = nn.Linear(64, 64)
#         self.fc3 = nn.Linear(64, action_dim_1)
#         self.fc4 = nn.Linear(64, action_dim_2)
#         self.relu = nn.ReLU()
...
#         action_prob_1 = self.softmax(self.fc3(x))
#         action_prob_2 = self.softmax(self.fc4(x))
#         return action_prob_1, action_prob_2
